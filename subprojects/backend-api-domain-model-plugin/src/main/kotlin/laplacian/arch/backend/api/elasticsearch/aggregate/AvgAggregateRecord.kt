 ...
 */
data class AvgAggregateRecord (
    private val __record: Record,
    private val _context: Context,
    private val _record: Record = __record.normalizeCamelcase()
): ElasticsearchAggregateRecord(__record, _context), AvgAggregate {

    /**
     * Returns wether this instance is a avg_aggregate or not.
     */
    override val isaAvgAggregate: Boolean = true
    ...
    companion object {
        ...
        fun from(record: Record, _context: Context) =
            AvgAggregateRecord(record, _context)
    }
    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is AvgAggregateRecord) return false
