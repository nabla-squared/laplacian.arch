 ...
 */
data class MaxAggregateRecord (
    private val __record: Record,
    private val _context: Context,
    private val _record: Record = __record.normalizeCamelcase()
): ElasticsearchAggregateRecord(__record, _context), MaxAggregate {

    /**
     * Returns wether this instance is a max_aggregate or not.
     */
    override val isaMaxAggregate: Boolean = true
    ...
    companion object {
        ...
        fun from(record: Record, _context: Context) =
            MaxAggregateRecord(record, _context)
    }
    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is MaxAggregateRecord) return false
