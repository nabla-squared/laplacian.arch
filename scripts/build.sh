...
DATABASE_DEPLOYMENT_TEMPLATE_MODULE_NAME='database-deployment-template'
DATABASE_DEPLOYMENT_TEMPLATE_DIR="$SUBPROJECTS_DIR/$DATABASE_DEPLOYMENT_TEMPLATE_MODULE_NAME"
DATABASE_DEPLOYMENT_TEMPLATE_MODULE_PATH="$DIST_DIR/$GROUP.$DATABASE_DEPLOYMENT_TEMPLATE_MODULE_NAME-$VERSION.zip"

ELASTICSEARCH_DEPLOYMENT_TEMPLATE_MODULE_NAME='elasticsearch-deployment-template'
ELASTICSEARCH_DEPLOYMENT_TEMPLATE_DIR="$SUBPROJECTS_DIR/$ELASTICSEARCH_DEPLOYMENT_TEMPLATE_MODULE_NAME"
ELASTICSEARCH_DEPLOYMENT_TEMPLATE_MODULE_PATH="$DIST_DIR/$GROUP.$ELASTICSEARCH_DEPLOYMENT_TEMPLATE_MODULE_NAME-$VERSION.zip"

REDIS_DEPLOYMENT_TEMPLATE_MODULE_NAME='elasticsearch-deployment-template'
REDIS_DEPLOYMENT_TEMPLATE_DIR="$SUBPROJECTS_DIR/$REDIS_DEPLOYMENT_TEMPLATE_MODULE_NAME"
REDIS_DEPLOYMENT_TEMPLATE_MODULE_PATH="$DIST_DIR/$GROUP.$REDIS_DEPLOYMENT_TEMPLATE_MODULE_NAME-$VERSION.zip"
...
update_distribution() {
  ...
  (cd $DATABASE_DEPLOYMENT_TEMPLATE_DIR
    $ZIP $DATABASE_DEPLOYMENT_TEMPLATE_MODULE_PATH . ) && \
  (cd $ELASTICSEARCH_DEPLOYMENT_TEMPLATE_DIR
    $ZIP $ELASTICSEARCH_DEPLOYMENT_TEMPLATE_MODULE_PATH . ) && \
  (cd $REDIS_DEPLOYMENT_TEMPLATE_DIR
    $ZIP $REDIS_DEPLOYMENT_TEMPLATE_MODULE_PATH . )
}
...
update_local_modules() {
  ...
  cp -f \
    ...
    $DATABASE_DEPLOYMENT_TEMPLATE_MODULE_PATH \
    $ELASTICSEARCH_DEPLOYMENT_TEMPLATE_MODULE_PATH \
    $REDIS_DEPLOYMENT_TEMPLATE_MODULE_PATH \
    $LAPLACIAN_CACHE_DIR
}
